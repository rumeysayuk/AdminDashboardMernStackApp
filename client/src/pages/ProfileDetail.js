      ...
      <div className="container mx-auto">
         <div>
            <div className={"flex justify-between align-middle flex-row"}>
               <div className="text-center mt-20 mb-4 ml-5 dark:text-gray-300"
                  ...
                  {/*        className="ml-3 h-10 text-md align-middle justify-center flex rounded-lg hover:bg-light-gray">*/}
                  {/*   Delete my account*/}
                  {/*</button>*/}
         ...
         <form>
            <div className="grid gap-6 mb-6 md:grid-cols-2">
               <div>
                  <label htmlFor="formFile" className="form-label inline-block mb-2 text-gray-700 dark:text-gray-300">Profile
                     Image</label>
                  <input
